...
sampling events. The site distance from its spring and the site altitude were
...
(resp. $r^2 = `r result_compo$r[1]`$, $r^2 = `r result_compo$r[2]`$). 
...
to latitude,  
We found that species richness increased by $`r bt_lm[["Latitude"]]$Estimate`$ 
($`r bt_lm[["Latitude"]]$SE`$ se) with latitude .
