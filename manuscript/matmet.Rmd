...
kable(result_compo, caption = "Result of the fit of environmental variables
  onto ordination.") 
...
\@ref(fig:nmds-p), Table \@ref(tab:nmds)). Latitude and longitude were the
...
Analogously to community composition, species richness was significantly related
to latitude, sprin,
...
$`r out[["Spring distance"]]$Estimate`$ log-unit ($`r out[["Spring
distance"]]$SE`$ se) by meter distance from the spring. However, longitude and
