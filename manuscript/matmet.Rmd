...
species cooccurence was assessed following the probabilistic model of @veech_probabilistic_2013,
with $\alpha = .1$. Only the species pairs with an expected
cooccurence superior to 1 were kept in the analysis. The analysis of species
cooccurence were done with the `cooccur` R package [@griffith_cooccur_2016].
