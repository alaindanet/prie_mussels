...
fig_nmds_path <- "~/Dropbox/_0_MollEcol_2/_Review/fig/nmds.png" 
...
mysave(model.1, lm_res_tab, lm_res_tab_to_print, dir = get_mypath("data"), overwrite = TRUE)
...
save_plot(
  ...
  filename = "~/Dropbox/_Review/fig_alain/richness_model.png",
...
fig_dir <- "~/Dropbox/_Review/fig_alain" 
