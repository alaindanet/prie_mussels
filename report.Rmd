...
model_richness_env <- glmmTMB(richness_native ~ scale(latitude)*scale(longitude) + scale(avAltA) + scale(upDist) + (1|basin),
...
TODO: Effet de l'invasion de swoo sur mat grosses sp; hypothèse de compétition
forte

# Co-occurence

```{r}
#TODO: separate patterns for little and big species 
```
